...
# Generated by qmake (2.01a) (Qt 4.5.1) on: Sat May 4 08:34:59 2019
# Project:  graph.pro
# Template: app
# Command: c:\Qt\2009.02\qt\bin\qmake.exe -spec ../Qt/2009.02/qt/mkspecs/win32-g++ -win32 CONFIG+=release -o Makefile graph.pro
#############################################################################
...
Makefile: graph.pro  ../Qt/2009.02/qt/mkspecs/win32-g++/qmake.conf ../Qt/2009.02/qt/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec ../Qt/2009.02/qt/mkspecs/win32-g++ -win32 CONFIG+=release -o Makefile graph.pro
